...
def __init__(self):
    ...
    def lin_reg(self,gp, year):
        model = LinearRegression()
        model.fit(self.data['FastestLap', 'GP'], self.data['FastestLapRace'])
        return  model.predict(DataAquisition(gp, year).get_fastest_laps()['FastestLap', 'GP'])


cake = DataModel()
print(cake.lin_reg('Monza', 2025))
'''